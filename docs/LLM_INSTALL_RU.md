...
5. Если пользователь явно требует текущий v2-флаг, используй
   `./scripts/install.sh --enable-remote-compaction-v2`.
6. Открой новую Codex-сессию и попроси пользователя проверить и доверить шесть
...
- Registered — бинарник и шесть hooks найдены.
